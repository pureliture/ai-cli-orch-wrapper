...
- Respect the context-sync contract. Treat root `CLAUDE.md` as the Claude source, `AGENTS.md` and `GEMINI.md` as generated target surfaces, and `.agents/skills/` as an allow-listed shared skill target.
