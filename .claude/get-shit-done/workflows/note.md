...
- **Global scope**: `/Users/pureliture/ai-cli-orch-wrapper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pureliture/ai-cli-orch-wrapper/.claude/notes/`)
...
2. Glob `/Users/pureliture/ai-cli-orch-wrapper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pureliture/ai-cli-orch-wrapper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pureliture/ai-cli-orch-wrapper/.claude/notes/` — works in any directory
