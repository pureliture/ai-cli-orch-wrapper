...
- Record the current implementation gaps between @pureliture/ai-cli-orch-wrapper and ccg-workflow's codeagent-wrapper so later implementation work has a stable baseline.
