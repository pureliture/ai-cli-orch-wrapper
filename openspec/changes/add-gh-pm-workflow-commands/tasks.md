...
- [x] 2.1 `.claude/commands/gh-issue.md` 생성 — `gh issue create` + 레이블 + Project #3 Backlog 배정 (`gh project item-add`)
- [x] 2.2 커맨드 파일에 conventional commit 제목 형식 안내 포함
- [x] 2.3 Epic 연결 옵션 (Parent epic: #N) 본문 포함 로직 추가

## 3. Base Commands: /gh-start

- [x] 3.1 `.claude/commands/gh-start.md` 생성 — 이슈 번호 인자 파싱, `gh issue view` 제목 조회
...
- [x] 4.1 `.claude/commands/gh-pr.md` 생성 — `gh pr create` + conventional commit 제목
...
- [x] 5.1 `.claude/commands/gh-followup.md` 생성 — PR 번호 인자 파싱
...
- [x] 6.1 `.claude/commands/gh-issue/multi.md` 생성 — `/octo:multi` 안내 후 `/gh-issue` 진행 안내
- [x] 6.2 `.claude/commands/gh-start/multi.md` 생성 — `/octo:multi` 안내 후 `/gh-start` 진행 안내
- [x] 6.3 `.claude/commands/gh-pr/multi.md` 생성 — PR readiness 검증 후 `/gh-pr` 진행 안내
- [x] 6.4 `.claude/commands/gh-followup/multi.md` 생성 — followup 내용 검증 후 `/gh-followup` 진행 안내
