...
- **New**: `/gh-issue` — 이슈 생성 + type/sprint 레이블 입력 + Project #3 Backlog 자동 배정
...
- **New**: `:multi` variants — 위 4개 커맨드 각각에 대해 `/octo:multi` 검증을 결합한 variant (`templates/commands/gh-*/multi.md`)
...
- `templates/commands/` — 신규 파일 8개 (gh-issue.md, gh-start.md, gh-pr.md, gh-followup.md + 각 multi.md)
