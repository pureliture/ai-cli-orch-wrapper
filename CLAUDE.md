...
- **`packages/installer/`** — `aco-install`: npm-publishable installer CLI. Provides `aco-install pack install/uninstall/status/setup` and `aco-install provider setup <name>`.
