...
- Security vulnerabilities, injection, auth bypass, or secret exposure
...
- Performance bugs such as unbounded loops or memory leaks
- Incorrect interface contracts

**Minor** - Recommended
- Code quality issues that materially affect maintainability
